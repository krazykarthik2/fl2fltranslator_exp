...
class TrainingConfig:
    ...
    save_dir: str = "checkpoints/c_to_ir"
...
class Trainer:
    def __init__(self, config: TrainingConfig):
        ...
        self.model = CToIRModel(model_cfg, tgt_vocab_size=config.tgt_vocab_size).to(self.device)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train C→IR model (Stage 1)")
    parser.add_argument("--data-dir", default="dataset/samples")
    parser.add_argument("--save-dir", default="checkpoints/c_to_ir")
